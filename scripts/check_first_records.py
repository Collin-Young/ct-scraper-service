...
def main():
    with CaseScraper(headless=True) as scraper:
        ...
        first_page_first = driver.find_element(By.XPATH, "//a[contains(@id,'hlnkDocketNo')]").text
        ...
        second_page_first = driver.find_element(By.XPATH, "//a[contains(@id,'hlnkDocketNo')]").text
        print("first page first docket:", first_page_first)
        print("second page first docket:", second_page_first)
